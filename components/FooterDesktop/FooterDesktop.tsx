    ...
    >
      ...
      <div className='mt-[80px] w-[auto] md:w-[100%] flex flex-col md:flex-row gap-[10px] items-center md:items-start flex-nowrap md:flex-wrap'>
        <FooterLinks
          ...
          link1={`${process.env.NEXT_PUBLIC_INFO_URL}/about-your-baking-connection/`}
          title2='About The Bakers'
          link2={`${process.env.NEXT_PUBLIC_INFO_URL}/about-the-bakers/`}
          title3='FAQs'
          link3={`${process.env.NEXT_PUBLIC_INFO_URL}/faqs/`}
        />
        <FooterLinks
          header='Resources'
